  ...
  return (
    <div className="flex flex-col lg:flex-row items-start justify-between gap-16 mt-16 max-w-screen-xl mx-auto px-8 overflow-clip">
      <div className="w-full lg:w-1/2">
        <p className="text-primary-purple font-sans text-lg mb-4">
        ...
        <PrismicRichText
          ...
          components={serializer}
        />
        <p className="text-gray-darker font-sans text-lg">
        ...
        {slice.items.map((item, index) => (
          <div key={index} className="mb-6 last:mb-0">
            <button
              ...
              className="flex justify-between items-center w-full py-4 px-6 bg-silver-light text-left rounded-[16px] font-sans font-bold text-gray-darker"
            >
