        ...
        <div className="absolute top-7 left-3 sm:left-6 sm:top-7">
          {slice.variation === "information" && (
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 stroke-blue-300"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="flex flex-col gap-3">
              ...
              heading3: ({ children }) => (
                <h3
                  className={`font-display text-lg ${
                    (slice.variation === "information" && "text-blue-500") ||
          ...
          <PrismicRichText
            ...
            components={{
              ...
              list: ({ children }) => (
                <ul className="list-disc pl-5 mb-6 text-gray-500 space-y-2">
                  {children}
                </ul>
              ),
              oList: ({ children }) => (
                <ol className="list-decimal pl-5 mb-6 text-gray-500 space-y-2">
                  {children}
                </ol>
              ),
            }}
