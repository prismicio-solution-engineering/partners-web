  ...
  return (
    <div className="bg-[#E8F8F3] rounded-lg shadow p-6 flex flex-col md:flex-row items-start mb-6">
      ...
      <div className="md:ml-6 w-full">
        <h3 className="text-[#3BBB96] font-bold text-lg leading-6 my-4">{title}</h3>
  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-8">
        <h1 className="text-center text-[64px] font-bold leading-none text-[#8E44EC] mb-12">Certification Checklist</h1>
