    ...
    <div className="border-b border-gray-300 py-8">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-primary-purple text-white rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-purple"
      ...
      {isOpen && (
        <div className="mt-6 flex lg:flex-col lg:items-start">
          ...
          />
          <p className="text-gray-darker text-[18px] leading-[28px] font-medium tracking-[-1%] lg:text-[16px] lg:leading-[24px] ml-8 lg:ml-0">
            {description}
          </p>
        </div>
      )}
...
const ChecklistSection = () => {
  ...
  return (
    <section className="bg-[#E8F8F3] text-center py-16 px-8 lg:px-24">
      <h2 className="text-[48px] leading-[52px] font-bold text-primary-green tracking-[-3%] mb-16 lg:text-[32px] lg:leading-[36px]">
