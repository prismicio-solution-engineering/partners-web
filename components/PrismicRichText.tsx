...
import { PrismicRichText as BasePrismicRichText, JSXMapSerializer } from "@prismicio/react";
...
const defaultComponents: JSXMapSerializer = {
  ...
  listItem: ({ children }) => (
    <li className="mb-1 list-disc pl-1 last:mb-0 md:pl-2 text-lg list-inside text-[#171717]">{children}</li>
  ),
  oListItem: ({ children }) => (
    <li className="mb-1 list-decimal pl-1 last:mb-0 md:pl-2 text-lg list-inside text-[#171717]">{children}</li>
  ),
  list: ({ children }) => (
