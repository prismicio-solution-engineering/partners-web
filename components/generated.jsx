        ...
        <>
            ...
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#F5F5F5] py-16 rounded-lg">
                <div className="text-center mb-12">
                    ...
                    <h3 className="text-black text-3xl lg:text-4xl font-sans font-bold mb-6">Why Partner with Prismic?</h3>
                    <p className="text-lg text-[#171717]">
                        Discover the benefits of joining the Prismic Partner Program and how it can transform your agencys operations.
                    </p>
                </div>
                <div className="flex flex-wrap -mx-4">
                    {features.map((feature, index) => (
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start bg-[#ffffff] my-16 rounded-xl max-w-screen-xl mx-auto">
            ...
            <div className="md:w-1/2">
                <p className="font-sans text-lg text-[#171717] mb-6">
                    Join our partner program today and lets build exceptional experiences together.
                </p>
        ...
        >
            <div className="max-w-screen-xl">
                ...
                <p className="font-sans text-lg mb-12 max-w-md">
                    Join our partnership program to leverage the power of collaboration and innovation. Lets thrive together!
                </p>
...
export const FeatureSliceComponent = () => {
    const featuredBenefit = {
        ...
        description: "As a Prismic Partner, enjoy direct access to our support team along with a range of incentives designed to boost your agencys growth and success.",
        incentives: [
            ...
            <div className="flex flex-col w-full md:w-1/2 px-12">
                <div className="text-center md:text-left p-4">
                    ...
                    <p className="font-sans text-lg text-[#171717] my-5">
                        Here youll find answers to the most common questions asked about our partner program.
                    </p>
                </div>
                <div>
                    {faqs.map((faq, index) => (
...
export const AccordionComponentTwoColumns = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "You can apply through our online form. Once submitted, well get in touch to discuss the next steps.",
        },
        {
            question: "What are the benefits of partnering with Prismic?",
...
export const TestimonialsSlider = () => {
    const testimonials = [
        {
            quote: "Since partnering with Prismic, weve been able to scale our content delivery and simplify our workflows, positively impacting our bottom line.",
            author: "Alex Johnson",
        ...
        {
            quote: "Prismic has transformed the way we approach website development. Its an integral part of our toolkit now.",
            author: "Liam Wong",
